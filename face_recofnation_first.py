...
def detect_faces_and_eyes():
    ...
    face_cascade = cv.CascadeClassifier(r"C:/Users/guezm/OneDrive/Bureau/testting/libs/haarcascade_frontalface_default.xml")
    eye_cascade = cv.CascadeClassifier(r"C:/Users/guezm/OneDrive/Bureau/testting/libs/haarcascade_eye.xml")
